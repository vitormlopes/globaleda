...
/**
 * <p>
 * This class is a wrapper for {@link GlobalEda}.
 * </p>
 *
 ...
 */
@ProviderType
public class GlobalEdaWrapper
	extends BaseModelWrapper<GlobalEda>
	implements GlobalEda, ModelWrapper<GlobalEda> {

	public GlobalEdaWrapper(GlobalEda globalEda) {
		super(globalEda);
	}
	...
	@Override
	protected GlobalEdaWrapper wrap(GlobalEda globalEda) {
		return new GlobalEdaWrapper(globalEda);
	}
