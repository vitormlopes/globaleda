...
/**
 * Provides the local service interface for Noticia. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NoticiaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NoticiaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NoticiaLocalServiceUtil} to access the noticia local service. Add custom service methods to <code>noticias.sb.service.impl.NoticiaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
