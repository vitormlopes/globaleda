...
@Component(
		...
		public class SchedulerTask extends BaseMessageListener {
		  ...
		  /*
		   * Change this function to execute cron job
		   */
		  ...
		  private static final Log _log = LogFactoryUtil.getLog(SchedulerTask.class);
